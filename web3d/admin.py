...
class ProjectModelAdmin(admin.ModelAdmin):
    ...
    # 字段分组显示
    fieldsets = (
        ("基本信息", {"fields": ("name", "user", "status", "description")}),
        (
            "参数与时间",
            {
...
class PresetModelAdmin(admin.ModelAdmin):
    # 在列表页显示的字段
    list_display = ("id", "name", "user", "type", "is_public", "created_at")

    # 可搜索的字段
    search_fields = ("name", "description", "user__username")

    # 右侧过滤器
    list_filter = ("type", "is_public", "created_at", "user")
    ...
    # 字段分组显示
    fieldsets = (
        ("基本信息", {"fields": ("name", "user", "type", "is_public", "description")}),
        (
            "设计参数",
            {"fields": ("parts", "feature", "piece_tags"), "classes": ("collapse",)},
        ),
        ("时间信息", {"fields": ("created_at", "edited_at"), "classes": ("collapse",)}),
    )
...
class PieceModelAdmin(admin.ModelAdmin):
    ...
    # 字段分组显示
    fieldsets = (
        ("基本信息", {"fields": ("name", "user", "project", "type", "description")}),
        (
            "设计参数",
            {"fields": ("parts", "feature", "piece_tags"), "classes": ("collapse",)},
        ),
...
class TextureModelAdmin(admin.ModelAdmin):
    ...
    # 字段分组显示
    fieldsets = (
        ("基本信息", {"fields": ("name", "user", "file")}),
        ("纹理参数", {"fields": ("texture_tags",), "classes": ("collapse",)}),
        ("时间信息", {"fields": ("created_at", "edited_at"), "classes": ("collapse",)}),
    )
...
class DecorationModelAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("基本信息", {"fields": ("name", "user", "file")}),
        ("装饰参数", {"fields": ("decoration_tags",), "classes": ("collapse",)}),
        ("时间信息", {"fields": ("created_at", "edited_at"), "classes": ("collapse",)}),
    )
